...
_(Operator Rahasia Increment/Tukang Tambah Cepat:)_
...
Berlaku juga dengan konsep kebalikannya yakni _Tidak Sama/Berbeda Ciri-cirinya_: Pakai ketatnya hukum tanda seru kembar: `!==` dipaksa paten.

### 4. Operator Logika Silsilah (_Logical Operators_)
